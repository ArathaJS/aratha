...
class ConstraintCollector {
    ...
    _activateConstraint(constraint) {
        ...
        this._assert(constraint.toFormula()); console.log("Asserted " + constraint);
    }

    push(constraint) {
        this._constraintStack.push(constraint); console.log("Pushed " + constraint);
    ...
    async solvePrefix(constraints, prefixLength) {
        ...
        const status = await this.checkSat();
        if (status !== "sat") {
...
class DSE {
    ...
    async execute() {
        ...
        console.log(constraints.length + " constraints in path condition"); console.log(constraints)
