...
function toMZNConstraint(cons, solver) {
    ...
    if (expr instanceof Unary)
        mzn_cons += unaryToMZN(expr.op, expr.expr, solver);
...
//                solver.NLOCS++;
        ...
        return unaryToMZN(expr.op, expr.expr, "REP", solver);
    else
...
//    }
        ...
        return unaryToMZN(expr.op, expr.expr, "TYP");
    else
        console.log("Unsupported:", expr);
}
...
//    }
        ...
        return unaryToMZN(expr.op, expr.expr, "LOC");
    else
        console.log("Unsupported:", expr);
}

function unaryToMZN(op, arg, suff, solv) {
