...
class ParseInt extends SymbolicValue {
    constructor(str, radix) {
        ...
        this._ws = new Temporary("parseInt.ws." + parseIntNamer, "String");
        this._numPart = new Temporary("parseInt.numPart." + parseIntNamer, "String");
        this._rem = new Temporary("parseInt.rem." + parseIntNamer, "String");
        this._i = new Temporary("parseInt.i." + parseIntNamer, "Int");
        parseIntNamer++;
    }
