...
(function(sandbox) {
    ...
    const { Variable, Binary, Unary, GetField, PutField, DeleteField, StringToString, StringConcat, StringCharAt, StringSubstring, StringSlice, StringIndexOf, StringSearch, RegExpTest } = require("./symbolic");
