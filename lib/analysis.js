...
(function(sandbox) {
    ...
    const { Variable, Binary, Unary, GetField, PutField, DeleteField, StringToString, StringConcat, StringCharAt, StringIndexOf, StringSearch, RegExpTest } = require("./symbolic");
