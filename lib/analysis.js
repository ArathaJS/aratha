...
(function(sandbox) {
    ...
    function getVariable(inputs, type) {
        ...
        console.log("getVariable: " + name + ' ' + type)
    ...
    function createSolver(commandLog = null) {
        ...
        switch (SOLVER) {
            ...
            case "cvc4":
                ...
                break;
            case "G-Strings":
                solver = new G_Strings(process.env.GSTRINGS_PATH || "mzn-gstrings");
                break;
            default:
    ...
    class Jalangi2DSEAnalysis {
        ...
        invokeFunPre(iid, f, base, args, isConstructor) {
            ...
            if (isFunctionInstrumented(concF) || (!isConcolic(base) && !_.some(args, isConcolic))) {
